...
<link rel="stylesheet" type="text/css" href="/Public/css/index/stylesheets/premium.css">
    ...
    <script type="application/javascript" src="/Public/js/Home/usertask/moneylist.js"></script>
    ...
    <div class="div-pan" >
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-div-pan" >
                ...
                <div class="form-inline" class="search-tool" id="search-tool">
                    ...
                    <select data-width="150" class="selectpicker form-inline" name="" id="status" class="form-control">
                        <option value="0">全部名单</option>
                        <option value="2">任务完成</option>
                        <option value="1">任务失败</option>
                    </select>
                    &nbsp;&nbsp;<label>报名时间:</label>
                    ...
                    <input class="ic-reset" type="button" onclick="resetButton('2,3','tab')"/>
                </div>
            ...
            <!--<div id="toolbar" style="text-align: right">-->
                <!--<button onclick="moneyConfirm()" style="width: 85px;border-color:#1dace1;color: #1dace1" type="button" class="common-button">确定</button>-->
                <!--<button onclick="closeLayer()" style="width: 85px;color: #b8b8b8;margin-right: 10px" type="button" class="common-button">取消</button>-->
            <!--</div>-->
        </div>
    </div>

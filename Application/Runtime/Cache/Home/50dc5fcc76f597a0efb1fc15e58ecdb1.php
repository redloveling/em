...
<link rel="stylesheet" type="text/css" href="/Public/css/index/stylesheets/premium.css">
    ...
    <script type="application/javascript" src="/Public/js/Home/usertask/donelist.js"></script>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-div-pan" >
                <div class="form-inline" class="search-tool" id="search-tool">
                    ...
                    <input class="ic-reset" type="button" onclick="resetButton('1,2','tab')"/>
                </div>
                <div style="height: 20px;border-bottom: 1px dashed #dfdfdf"></div>
            <div id="toolbar">
                <button onclick="userTaskExport('userTaskDoneList')" type="button" class="common-button export-button-large">导出报名名单</button>
            </div>

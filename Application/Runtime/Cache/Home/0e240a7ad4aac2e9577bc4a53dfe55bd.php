...
<script type="text/javascript">
    ...
    <script src="/Public/js/home/user/payaudit.js" type="text/javascript"></script>
...
<div class="wrap">
    ...
    <?php foreach($payauditTabList as $key=>$value){ $tableNames .= $value['id'].','?>
    <div  class="task-title-div tab-div" id="task-title-id-<?=$value['id']?>" onclick="activeThis(this);changeTabDiv('tab-div-pan-<?=$value['id']?>')">
        ...
        <div class="lab">
            ...
            <span id="count_pay_<?=$value['id']?>"></span><font>条</font>
        </div>
    </div>
    <?php }?>
    ...
    <div class="table-list">
        <div class="main-content ">
            <?php foreach($payauditTabList as $key=>$value){?>

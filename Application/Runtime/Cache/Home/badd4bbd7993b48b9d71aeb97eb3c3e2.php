            ...
            <div class="col-md-2" style="padding-top: 15px">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="formId" method="post" name='formId' action='<?php echo U("Node/edit");?>'>
                            <input type="hidden" name="id" value="<?php echo ($nodeInfo["id"]); ?>"/>
                            <div class="form-group">
                                <label>节点名字</label>
                                <input type="text" name="name" value="<?php echo ($nodeInfo["name"]); ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>节点代码</label>
                                <input type="text" name="code" value="<?php echo ($nodeInfo["code"]); ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>所属分组</label>
                                <?php echo W('Node/select',array('id'=>$nodeInfo['id']));?>
                            </div>
                            <div class="form-group">
                                <label>状态</label>
                                <span class="form-control">
                                <label style="width: 100px"><input type="radio" name="status" value="1" <?php if($nodeInfo['status']==1){echo 'checked="true"';}?>/>正常</label>
                            ...
                            <div class="form-group">
                                <label>描述</label>
                                 <textarea name="description"  rows="3" class="form-control"><?php echo ($nodeInfo["description"]); ?></textarea>
                            </div>

...
<link rel="stylesheet" type="text/css" href="/Public/css/index/stylesheets/premium.css">
    ...
    <script type="application/javascript" src="/Public/js/Home/usertask/applylist.js"></script>
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div class="form-inline" class="search-tool" id="search-tool">
                ...
                <select data-width="150" class="selectpicker form-inline" name="" id="status" class="form-control">
                    <option value="1,2,3" >全部名单</option>
                    <option value="1">已报名/待录用</option>
                ...
                <input class="ic-reset" type="button" onclick="resetButton('1,2,3','tab')"/>
            </div>
            <div style="height: 20px;border-bottom: 1px dashed #dfdfdf"></div>
            <div id="toolbar">
                <label class="table-list-title">报名审核列表</label>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button onclick="userTaskExport('userTaskApplyList')" type="button" class="common-button export-button-large">导出报名名单</button>
                <button onclick="passApply()" type="button" class="common-button pass-button">通过</button>
                <button onclick="denyApply()" type="button" class="common-button del-button">拒绝</button>
            </div>

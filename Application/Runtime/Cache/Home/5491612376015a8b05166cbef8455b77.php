        ...
        <div class="col-md-2">
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane active in" id="home">
                    <form id="formId" method="post" name='formId' action='<?php echo U("Home/User/denyRealAudit");?>'>
                        <input type="hidden" name="auditId" value="<?=$auditId?>"/>

                        <div class="form-group">
                            <div class="choose-label">错误类型</div>
                            <?php echo W('Config/Select',array('tb_realaudit_refuse_type','refuse_type'));?>
                        </div>
                        <div class="form-group">
                ...
                <button class="btn btn-primary yes" onclick="fromSubmit('formId','noTab,alreadyTab')">
                </button>

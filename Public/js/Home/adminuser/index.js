...
$(function() {
    ...
    $('#add').click(function () {
        layer.open({
            ...
            shade: 0.1,
            area: ['380px', '480px'],
            content: '/index.php/AdminUser/add/' //iframe的url
        });
...
function handleData(id,type){
    $.post('./handleData/',{type:type,ids:id},function (data) {console.log(data)
        var res=eval('('+data+')') ;
        layer.msg(res.msg);
...
function edit(id){
    layer.open({
        ...
        shade: 0.1,
        area: ['380px', '440px'],
        content: '/index.php/AdminUser/edit/id/'+id //iframe的url
    });
}